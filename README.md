...
│   │   ├── shared/
│   │   │   ├── ImageProtection.tsx # Prevents image and link dragging
│   │   │   ├── Footer.tsx           # Dark theme footer
│   │   │   └── Navbar.tsx           # Navbar with active states & counters
│   │   └── ui/
│   │       ├── LoadingStates.tsx    # Branded loader and page skeletons
│   │       ├── SortSelect.tsx       # Cross-browser themed sort menu
...
│   ├── globals.css                  # Tailwind v4, typography, theme & scrollbar
